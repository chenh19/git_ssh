...
then
  ...
  case "$choice" in
    ...
    y|Y ) # notify start
        ...
        echo -e " \n${TEXT_GREEN}You may copy the above key and add it to your GitHub. Or, it's also save in ~/Documents/gitssh.txt file in case you want to work on it later.${TEXT_RESET} \n" && sleep 5;;
